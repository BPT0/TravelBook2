                        ...
                        .addOnCompleteListener {task ->
                            ...
                            if (task.isSuccessful){ // 가입성공시
                                if (firebaseUser != null){
                                    ...
                                    Toast.makeText(this@Register2Activity, "회원가입에 성공하셨습니다.", Toast.LENGTH_SHORT).show()

                                    // shared pref 로 앱 최초 실행 여부 기억
                                    MyApplication.prefs.setString("isFirst", "true")

                                    // 로그인 화면으로 이동
                                    val lIntent = Intent(this@Register2Activity, LoginActivity::class.java)
                                ...
                                print(task.result)
                                Toast.makeText(this@Register2Activity, "회원가입에 실패하셨습니다.", Toast.LENGTH_SHORT).show()
                            }
                    }
                }
            }
